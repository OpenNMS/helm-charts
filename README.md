...
If you are not already familiar with Horizon or Meridian, we recommend reviewing our [product documentation](https://docs.opennms.com/horizon/32/deployment/core/introduction.html) and our [Horizon](https://www.opennms.com/horizon/) or [Meridian](https://www.opennms.com/meridian/) websites.
...
| core.image.repository | string | `"opennms/horizon"` or `"opennms/meridian"` |  |
