...
| core.env.CORE_SERVICE_ALARMD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_BSMD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_TICKETER_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_CORRELATOR_ENABLED | string | `"false"` |  |
| core.env.CORE_SERVICE_ACTIOND_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_NOTIFD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_SCRIPTD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_RTCD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_POLLERD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_SNMPPOLLER_ENABLED | string | `"false"` |  |
| core.env.CORE_SERVICE_ENHANCEDLINKD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_COLLECTD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_DISCOVERY_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_VACCUMD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_EVENTTRANSLATOR_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_PASSIVESTATUSD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_STATSD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_PROVISIOND_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_REPORTD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_ACKD | string | `"true"` |  |
| core.env.CORE_SERVICE_JETTYSERVER_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_KARAFSTARTUPMONITOR_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_TL1D_ENABLED | string | `"false"` |  |
| core.env.CORE_SERVICE_SYSLOGD_ENABLED | string | `"false"` |  |
| core.env.CORE_SERVICE_ASTERISKGATEWAY_ENABLED | string | `"false"` |  |
| core.env.CORE_SERVICE_TELEMETRYD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_TRAPD_ENABLED | string | `"true"` |  |
| core.env.CORE_SERVICE_PERSPECTIVEPOLLER | string | `"false"` |  |
