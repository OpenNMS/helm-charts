...
| minion.configuration.livenessProbe.failureThreshold | int | `3` |  |
| minion.configuration.livenessProbe.initialDelaySeconds | int | `10` |  |
| minion.configuration.livenessProbe.periodSeconds | int | `10` |  |
| minion.configuration.livenessProbe.timeoutSeconds | int | `5` |  |
...
| minion.configuration.readinessProbe.failureThreshold | int | `3` |  |
| minion.configuration.readinessProbe.initialDelaySeconds | int | `45` |  |
| minion.configuration.readinessProbe.periodSeconds | int | `60` |  |
| minion.configuration.readinessProbe.timeoutSeconds | int | `20` |  |
